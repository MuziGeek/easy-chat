...
import com.muzi.easychat.user.domain.enums.WSRespTypeEnum;
...
import static com.muzi.easychat.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.muzi.easychat.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;

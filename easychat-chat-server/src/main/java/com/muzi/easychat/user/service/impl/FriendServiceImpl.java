...
import com.muzi.easychat.chat.service.adapter.MessageAdapter;
...
import com.muzi.easychat.common.domain.vo.request.PageBaseReq;
import com.muzi.easychat.common.domain.vo.response.CursorPageBaseResp;
import com.muzi.easychat.common.domain.vo.response.PageBaseResp;
...
import com.muzi.easychat.user.dao.UserFriendDao;
...
import com.muzi.easychat.user.domain.vo.request.friend.FriendApplyReq;
import com.muzi.easychat.user.domain.vo.request.friend.FriendApproveReq;
import com.muzi.easychat.user.domain.vo.request.friend.FriendCheckReq;
import com.muzi.easychat.user.domain.vo.response.friend.FriendApplyResp;
import com.muzi.easychat.user.domain.vo.response.friend.FriendCheckResp;
import com.muzi.easychat.user.domain.vo.response.friend.FriendResp;
import com.muzi.easychat.user.domain.vo.response.friend.FriendUnreadResp;
import com.muzi.easychat.user.service.FriendService;
import com.muzi.easychat.user.service.adapter.FriendAdapter;

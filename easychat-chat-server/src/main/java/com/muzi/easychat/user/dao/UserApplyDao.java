...
import com.muzi.easychat.user.domain.enums.ApplyStatusEnum;
import com.muzi.easychat.user.domain.enums.ApplyTypeEnum;
import com.muzi.easychat.user.mapper.UserApplyMapper;
...
import static com.muzi.easychat.user.domain.enums.ApplyReadStatusEnum.READ;
import static com.muzi.easychat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.muzi.easychat.user.domain.enums.ApplyStatusEnum.AGREE;

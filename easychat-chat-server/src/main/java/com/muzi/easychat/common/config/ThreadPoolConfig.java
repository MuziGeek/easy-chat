...
import com.muzi.easychat.common.factory.MyThreadFactory;
import com.muzi.easychat
.transaction.annotation.SecureInvokeConfigurer;
...
public class ThreadPoolConfig implements AsyncConfigurer, SecureInvokeConfigurer {
     ...
     * 项目共用线程池
     */
    public static final String MALLCHAT_EXECUTOR = "easychatExecutor";
    /**
     * websocket通信线程池
     */
